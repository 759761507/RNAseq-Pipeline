...
This folder contains a Wiki-ready dry-lab package for extracting transcriptome-wide C-to-U candidate editing sites from RNA-seq/SRA data and converting them into AI-ready labels for downstream LAMAR-style modeling.
